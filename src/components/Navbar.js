...
const Navbar = () => {
  ...
  return (
    ...
    <div className="no-underline  items-center gap-4 md:flex hidden font-larsseit">
      ...
      {/* <button className="text-black text-[15px] bg-[#FFFFFF] hover:bg-[#FFFFFF] ease-in-out duration-500 py-1 px-4 rounded-lg font-light tracking-wide"><a href="#signin">Sign in</a></button> */}

       <Link to="/signin" class="relative inline-flex items-center justify-center py-1 px-4 overflow-hidden font-medium text-black transition duration-300 ease-in-out  bg-[#FFFFFF] rounded-lg  group">
<span class="absolute inset-0 flex items-center justify-center w-full h-full text-black duration-300 -translate-x-full bg-[rgb(255,255,255)] group-hover:translate-x-0 ease">
<FontAwesomeIcon icon={faLockOpen} />
 ...
 <span class="relative invisible">Sign in</span>
     ...
     <div className="md:hidden flex flex-1 justify-end items-center">
       ...
       <Link to="/signin" class="relative inline-flex items-center justify-center py-1 px-4 overflow-hidden font-medium text-black transition duration-300 ease-in-out  bg-[#FFFFFF] rounded-lg  group">
<span class="absolute inset-0 flex items-center justify-center w-full h-full text-black duration-300 -translate-x-full bg-[#FFFFFF] group-hover:translate-x-0 ease">
<FontAwesomeIcon icon={faLockOpen} />
</span>
<span class="absolute flex items-center justify-center w-full h-full text-black transition-all duration-300 transform group-hover:translate-x-full ease">Sign in</span>
<span class="relative invisible">Sign in</span>
...
//        <a href="#signin" class="relative inline-flex items-center justify-center py-1 px-4 overflow-hidden font-medium text-black transition duration-300 ease-in-out  bg-[#FFFFFF] rounded-lg  group">
// <span class="absolute inset-0 flex items-center justify-center w-full h-full text-black duration-300 -translate-x-full bg-[#FFFFFF] group-hover:translate-x-0 ease">
// <FontAwesomeIcon icon={faLockOpen} />
// </span>
// <span class="absolute flex items-center justify-center w-full h-full text-black transition-all duration-300 transform group-hover:translate-x-full ease">Sign in</span>
