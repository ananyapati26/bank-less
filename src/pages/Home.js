...
<motion.div variants={textVariant(0.3)} >
  ...
  With a BANKLESS you can access the more than 240 million customers out there, as well as offering management tools, options, and payment methods.
</p>
</motion.div>
...
accounts, credit cards, investments, and bills.
      ...
      {/* <button className="  mt-8 text-black text-[15px] bg-[#0096FF] hover:bg-[#43ee60] ease-in-out duration-500 py-2 px-6 rounded-lg font-bold tracking-wide"><a href="#signin">Try for now <FontAwesomeIcon icon={faArrowRight} />  </a></button> */}
      <motion.div variants={textVariant(0.4)} >
